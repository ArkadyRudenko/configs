...
myTerminal      = "/home/arkady/.cargo/bin/alacritty"
myFocusFollowsMouse = False
myClickJustFocuses = False

myModMask       = mod1Mask -- or mod4Mask for super
myWorkspaces    = ["web","code","a","tg","c","d", "other"]
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((mod4Mask, xK_e), (windows $ W.greedyView "mx") >> spawn "/home/arkady/.cargo/bin/alacritty -t mutt -e tmux new-session -A -s mail /bin/bash -ic \"mutt -e 'source ~/.mutt/account.fm'\"")
    ...
    , ((0, xF86XK_Display), (spawn "sudo -E ~arkady/bin/hotplug-dp.sh &"))
...
myStartupHook = do
  ...
  spawnOnce "/home/arkady/cargo-target/release/buzz"
